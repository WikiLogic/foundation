...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Thank you for helping us out! You rock.', 'bonestheme' );
}
...
/*
 * Adding styles to the admin
 * Generally hiding things I don't want people clicking :P
 */
