	...
	<div class="body">
		...
		<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
			...
			<div class="header__top">
				...
				<label class="header__search-close" for="search-toggler">
					<!-- Maginfying glass -->
			...
			<input type="checkbox" id="search-toggler" class="header__search-toggler"/>
		...
		<input type="checkbox" id="menu-toggler" class="header__bottom-toggler"/>
